...
export default function HomePage() {
  ...
  // --- FIXED: Create stable string dependencies for the useEffect hook ---
  const countryDep = selectedCountries.join(',');
  const employeeDep = selectedEmployeeSizes.join(',');
  ...
  useEffect(() => {
    ...
    fetchData();
  // FIXED: The dependency array now uses the stable string representations
  }, [reportFocus, selectedMetricsDep, kpiConfigDep, timePeriod, countryDep, employeeDep, chartMode, singleChartMetric, segmentationProperty, multiChartMetricsDep]);
