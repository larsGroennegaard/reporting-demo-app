...
export default function HomePage() {
  ...
  // FIXED: Create stable string dependencies for the main useEffect hook
  ...
  useEffect(() => {
    ...
    fetchData();
  // FIXED: The dependency array uses the stable string representations to prevent the infinite loop
