...
export default function HomePage() {
  // --- Top-level state for the report type ---
  ...
  // --- FIX: This useEffect hook is now at the top level, where it belongs ---
  useEffect(() => {
  ...
  useEffect(() => {
    // This effect needs to run *after* the state has been reset, so it's placed after the reset effect.
